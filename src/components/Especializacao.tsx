...
export function Especializacao() {
  return (
    <section id="especializacao" className="relative py-14 md:py-24 lg:py-32 px-4 md:px-6 bg-gradient-to-b from-black via-neutral-950 to-black overflow-hidden">
